...
The pipeline schematic appears at the top of Section~\ref{sec:methods} (Figure~\ref{fig:f1-pipeline}). The qualitative comparison between teacher and the deployable student is in Figure~\ref{fig:f3-qualitative} (supplementary).
