...
Figure~\ref{fig:f3-qualitative} (supplementary) shows that both teacher and EfficientNet-Lite0-INT8 student share two persistent failure modes:
\begin{itemize}
