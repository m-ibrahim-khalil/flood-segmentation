...
\author[affA]{Tasfia Noor Chawdhury}
\author[sensa]{Md Ibrahim Khalil\corref{cor1}}
\ead{ibrahim@sensa.no}
\author[affC]{Md Ikramul Haque}% NOTE: marked optional by authors; remove if not included.

% TODO before submission: confirm affiliations (and emails/ORCIDs) for
% Chawdhury and Haque. Placeholders below are visible in the compiled PDF.
\affiliation[affA]{
  organization={[Affiliation for T.\,N.\ Chawdhury --- to be confirmed]},
}
\affiliation[sensa]{
...
\affiliation[affC]{
  organization={[Affiliation for M.\,I.\ Haque --- to be confirmed]},
}
...
% --- Appendices ---
\appendix
\input{sections/09_appendix_reproducibility}
