...
\textbf{Reproducibility and openness.} All code, ONNX exports, per-fold checkpoints, and benchmarking harnesses are released under MIT licence at \url{https://github.com/m-ibrahim-khalil/flood-segmentation}. A Zenodo-archived snapshot (DOI to be minted at acceptance) will be linked in the camera-ready. The FSSD dataset is publicly available on Kaggle.
